...
Write a function named validatePin
that uses a regular expression pattern to validate a PIN.

If the PIN is four numerical digits long, return true.
...
Write a function named validateWord that
uses a regular expression pattern to validate
that a word is between 5 and 10 characters long.

If the word is between 5 and 10 characters long,
...
Write a function named hasNumber that
uses a regular expression pattern
to determine if a string has one or more letter
...
Write a function named validateEmail that
takes in an email address and validates it based
on several rules:
...
const validateEmail = (email) => {
  return /^\w+\.?\w+\@\w+(\.com|\.net|\.org)\b$/.test(email);
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 6

Write a function named validatePhoneNumber that accepts a phone number
...
const validatePhoneNumber = (phoneNumber) => {
  return /^(\([0-9]{3}\)|^[0-9]{3})\-?\s?\d{3}\s?\-?\d{4}\b$/.test(phoneNumber);
};
