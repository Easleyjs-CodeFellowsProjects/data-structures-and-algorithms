...
const sortByChildren = (charArray) => {
  return charArray.sort(( a, b ) => {
    ...
    const bLength = b.children.length;
...
This function should use a regular expression pattern to return true if the string contains the letter 'w' in lower case
...
const citiesAtoJ = (arr) => {
  return arr.filter(city => /^[A-J]\w*/.test(city) );
};
